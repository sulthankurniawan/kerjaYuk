                ...
                <form>
                    <div class="form-row">
                        <div class="form-group col-md-6 pr-md-3">
                            <label for="#" class="body-small">Mata Uang</label>
                            <input type="text" class="form-control custom-text-input" id="currency"
                                placeholder="e.g. IDR - Rp">
                        </div>
                        <div class="form-group col-md-6 pl-md-3">
                            <label for="#" class="body-small">Per tahun</label>
                            <input type="text" class="form-control custom-text-input" id="per year"
