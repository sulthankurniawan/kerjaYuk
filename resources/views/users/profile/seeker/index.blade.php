...
<main>
    <section class="section-profile-seeker">
        <div class="container-fluid">
            <div class="row">
                <div class="sidebar col-12 col-lg-3 p-0 border-right">
                    <div class="avatar">
                    ...
                    <div class="informasi-pribadi p-4 bg-white h-100 d-none d-lg-block">
                        <h5 class="profile-username text-left mb-3">Informasi Pribadi</h5>
                        <form action="" class="informasi-pribadi">
                            ...
                            <div class="form-group">
                                <span><i class="fas fa-envelope mr-2 text-body"
                                        style="min-width: 20px;"></i>Email</span>
                ...
                <div class="information bg-white col-12 col-lg-9 p-0">
                    <div class="container">
                        <div class="box-profile p-4">
                            <form action="" class="informasi-pribadi h-100 d-block d-lg-none">
                            ...
                            <form action="" class="pengalaman">
                                ...
                                <a href="../../pages/seeker/profile_seeker_edit_pengalaman_kerja.html"
                                    class="btn btn-grey primary btn-block"><i
                                        class="fas fa-plus-circle mr-2"></i>Perbaharui</a>
                            </form>
