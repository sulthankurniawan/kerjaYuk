    ...
    <footer class="footer-2-3 container-xxl mx-auto position-relative p-0">
        <div class="list-footer">
            <div class="row gap-md-0 gap-3">
                <div class="col-lg-3 col-md-12">
                    <div class="">
                        <div class="list-space">
                            <h2 style="color: #f55151;">KerjaYuk</h2>
                            <p>We transform the way candidates find jobs and companies hire talent.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <h2 class="footer-text-title text-white">About</h2>
                ...
                <div class="col-lg-3 col-md-4">
                    <h2 class="footer-text-title text-white">Job Seeker</h2>
                    <nav class="list-unstyled">
                        <li class="list-space">
                            <a href="" class="list-menu">Job Board</a>
                        </li>
                        <li class="list-space">
                            <a href="" class="list-menu">Career Advice</a>
                        </li>
                        <li class="list-space">
                ...
                <div class="col-lg-3 col-md-4">
                    <h2 class="footer-text-title text-white">Employer</h2>
                    <nav class="list-unstyled">
                        <li class="list-space">
                            <a href="" class="list-menu">Post a Job</a>
                        </li>
                        <li class="list-space">
                            <a href="" class="list-menu">Pricing</a>
                        </li>
                        <li class="list-space">
                            <a href="" class="list-menu">Employer Help</a>
                        </li>
                    </nav>
                </div>
            </div>
        ...
        <div class="border-color info-footer">
            <div class="">
                <hr class="hr" style="border-color: #bdbdbd;" />
            </div>
            <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space">
                <div class="d-flex title-font font-medium align-items-center my-3">
                    <a href="" class="pr-3">
                ...
                <nav class="mx-auto d-flex flex-wrap align-items-center justify-content-center my-3">
                    <a href="" class="footer-link px-3 mb-3 mb-lg-0" style="text-decoration: none">Terms of Service</a>
                    <span class="mb-3 mb-lg-0" style="color: #ffffff">|</span>
                    <a href="" class="footer-link px-3 mb-3 mb-lg-0" style="text-decoration: none">Privacy Policy</a>
                    <span class="mb-3 mb-lg-0" style="color: #ffffff">|</span>
                    <a href="" class="footer-link px-3 mb-3 mb-lg-0" style="text-decoration: none">Licenses</a>
                </nav>
                <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center"
                    style="color: #ffffff;">
                    <p style="margin: 0">Copyright © 2021 KerjaYuk</p>
                </nav>
            </div>
        </div>
    </footer>
