            ...
            <div class="card card-body border-0">
                ...
                <form action="{{ route('jobs.update', $job->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="location_link" placeholder="Link lokasi" name="location_link" value="{{ $job->location_link }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="kemampuan" rows="4"
                            placeholder="Tuliskan kemampuan yang diperlukan..." name="skill">{{ $job->skill }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="kadaluarsa" name="expiration" value="{{$job->expiration}}" required>
                    </div>
                    <div class="form-group">
                        <label for="pengalaman">Penampilan Lowongan:</label>
                        <select class="form-control" id="pengalaman" name="display">
                            <option <?= ($job->display == 'Tampilkan') ? 'selected' : ''; ?>>Tampilkan</option>
                            <option <?= ($job->display == 'Sembunyikan') ? 'selected' : ''; ?>>Sembunyikan</option>
                        </select>
                    </div>

                    <button type="submit" class="btn btn-orange btn-block mb-2 mb-md-0">Perbarui Informasi</button>
                </form>
            </div>
        </div>
    </section>
