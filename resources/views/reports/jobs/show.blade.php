                ...
                <ul class="list-group mb-3 ml-3">
                    <li class="list-group-item border-0 d-flex align-items-center pl-0 pt-1">
                        <div class="d-flex w-100">
                            ...
                            <div class="w-100">
                                <p class="mb-0">{{ $reported_job->name }}</p>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item border-0 d-flex align-items-center pl-0 pt-1">
                        <div class="d-flex w-100">
                            <div class="h-100 list-bullet-icons">
                                <span style="margin-right:5px">Perusahaan: </span>
                            </div>
                            <div class="w-100">
                                <p class="mb-0">{{ $reported_job->company }}</p>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item border-0 d-flex align-items-center pl-0 pt-1">
                        <div class="d-flex w-100">
                            ...
                            <div class="w-100">
                                <a href="mailto: {{ $reported_job->email }}" style="color:black">{{ $reported_job->email }}</a>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item border-0 d-flex align-items-center pl-0 pt-1">
                        <div class="d-flex w-100">
                            ...
                            <div class="w-100">
                                <a href="https://api.whatsapp.com/send?phone={{ $reported_job->phone }}" style="color:black">{{ $reported_job->phone }}</a>
                            </div>
                        </div>
                    </li>
                    <li class="list-group-item border-0 d-flex align-items-center pl-0 pt-1">
